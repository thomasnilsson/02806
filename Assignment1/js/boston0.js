(() => {
	...
	var handleMouseOverBoston = (dot, d) => {
		...
		var xPos = d3.event.clientX +10
		var yPos = d3.event.clientY + 2800
	...
	var plotLegend = () => {
		...
		svgBoston.append("text")
			...
			.attr("fill", "blue")
			.attr("x", marginsBoston.right + 50)
			.attr("y", marginsBoston.bottom / 2 + 100)
			.on("click", () => showBoth())
		...
		svgBoston.append("text")
			...
			.attr("fill", menColor)
			.attr("x", marginsBoston.right + 50)
			.attr("y", marginsBoston.bottom / 2 + 125)
			.on("click", () => onlyMen())

		svgBoston.append("text")
			.text("Show Women Only")
			.attr("fill", womenColor)
			.attr("x", marginsBoston.right + 50)
			.attr("y", marginsBoston.bottom / 2 + 150)
			.on("click", () => onlyWomen())
	}
